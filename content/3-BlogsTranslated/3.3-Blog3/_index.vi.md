...
# Voting System và Reputation Management cho Crowdsourcing Platform

Hệ thống voting và reputation là trái tim của TSL-SignMap, đảm bảo chất lượng dữ liệu từ cộng đồng. Bài viết này trình bày cách xây dựng voting system với DynamoDB và Lambda.

---

## Yêu cầu Voting System
...
**TrafficSigns Table (với Vote Counters)**
...
Voting system với DynamoDB cung cấp:
- **Scalability**: Xử lý millions votes/day
- **Real-time**: Atomic counters cho instant feedback
