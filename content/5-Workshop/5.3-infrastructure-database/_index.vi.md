...
Phần này triển khai 5 thành phần cốt lõi:
- **DynamoDB**: 3 tables lưu trữ dữ liệu (Signs, Users, Votes)
- **S3**: 2 buckets (images và ML models)
- **SQS**: 1 queue cho image processing
- **Cognito**: User Pool + Groups
- **Location Service**: Map index cho geospatial queries

---

### Bước 1: Setup AWS SAM
...
#### Configure CORS cho Images Bucket
...
**Queue Configuration:**
- Visibility Timeout: 15 phút (cho AI inference)
- Message Retention: 4 ngày
- Max Receive Count: 3 lần → DLQ
- Long Polling: 20 seconds

---

### Bước 5: Setup Cognito User Pool
...
### Bước 6: Setup Amazon Location Service
...
**Note:** Chi phí thực tế phụ thuộc vào usage. On-Demand billing linh hoạt theo traffic.
